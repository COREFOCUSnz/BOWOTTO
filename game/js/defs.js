...
(function (root) {
  'use strict';
  const WEAPONS = {
    crowbar: { name: 'Crowbar', short: 'Crowbar', type: 'melee', dmg: 25, rate: 0.5, range: 1.6, model: 'melee' },
    knife: { name: 'Knife', short: 'Knife', type: 'melee', dmg: 40, rate: 0.5, range: 1.6, backstab: true, model: 'melee' },
    spanner: { name: 'Spanner', short: 'Spanner', type: 'melee', dmg: 20, rate: 0.5, range: 1.6, model: 'melee' },
    medkit: { name: 'Medikit', short: 'Medikit', type: 'melee', dmg: 10, rate: 0.5, range: 1.8, heal: 30, infect: true, model: 'melee' },
    shotgun: { name: 'Shotgun', short: 'Shotgun', type: 'hitscan', ammo: 'shells', perShot: 1, rate: 0.5, pellets: 6, dmg: 4, spread: 0.04, model: 'shotgun' },
    supershotgun: { name: 'Super Shotgun', short: 'Super SG', type: 'hitscan', ammo: 'shells', perShot: 2, rate: 0.7, pellets: 14, dmg: 4, spread: 0.07, model: 'supershotgun' },
    nailgun: { name: 'Nailgun', short: 'Nailgun', type: 'proj', ammo: 'nails', perShot: 1, rate: 0.1, proj: 'nail', dmg: 9, speed: 50, model: 'nailgun' },
    supernailgun: { name: 'Super Nailgun', short: 'S.Nailgun', type: 'proj', ammo: 'nails', perShot: 2, rate: 0.1, proj: 'nail', dmg: 13, speed: 50, model: 'nailgun' },
    rpg: { name: 'Rocket Launcher', short: 'Rockets', type: 'proj', ammo: 'rockets', perShot: 1, rate: 0.8, proj: 'rocket', dmg: 92, radius: 4.2, speed: 27, model: 'rpg' },
    gl: { name: 'Grenade Launcher', short: 'Pipes', type: 'proj', ammo: 'rockets', perShot: 1, rate: 0.6, proj: 'pipe', dmg: 100, radius: 4, speed: 22, fuse: 2.5, model: 'gl' },
    pl: { name: 'Pipebomb Launcher', short: 'Pipebombs', type: 'proj', ammo: 'rockets', perShot: 1, rate: 0.6, proj: 'pipebomb', dmg: 100, radius: 4, speed: 20, detonate: true, model: 'gl' },
    sniper: { name: 'Sniper Rifle', short: 'Sniper', type: 'charge', ammo: 'shells', perShot: 1, rate: 1.4, dmg: 45, maxDmg: 380, chargeTime: 2.5, zoom: true, model: 'sniper' },
    autorifle: { name: 'Auto Rifle', short: 'Autorifle', type: 'hitscan', ammo: 'shells', perShot: 1, rate: 0.1, pellets: 1, dmg: 8, spread: 0.02, model: 'autorifle' },
    ac: { name: 'Assault Cannon', short: 'A.Cannon', type: 'hitscan', ammo: 'shells', perShot: 1, rate: 0.08, pellets: 3, dmg: 6, spread: 0.09, spinup: 0.7, slow: 0.55, model: 'ac' },
    flamer: { name: 'Flamethrower', short: 'Flamer', type: 'flame', ammo: 'cells', perShot: 1, rate: 0.08, dmg: 6, range: 7, burn: 3, model: 'flamer' },
    ic: { name: 'Incendiary Cannon', short: 'Incendiary', type: 'proj', ammo: 'rockets', perShot: 1, rate: 1.0, proj: 'ic', dmg: 55, radius: 3.5, speed: 30, burn: 4, model: 'rpg' },
    tranq: { name: 'Tranquilizer', short: 'Tranq', type: 'proj', ammo: 'shells', perShot: 1, rate: 1.5, proj: 'dart', dmg: 18, speed: 40, slow: 5, model: 'autorifle' },
    railgun: { name: 'Railgun', short: 'Railgun', type: 'hitscan', ammo: 'nails', perShot: 1, rate: 0.4, pellets: 1, dmg: 20, spread: 0.0, tracer: 1, model: 'autorifle' },
  };
  const GRENADES = {
